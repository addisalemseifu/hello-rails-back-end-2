...
<div align="center">
  ...
  <h1><b>hello-rails-backend-2</b></h1>
...
- [📖 Fullstack - Rails with React ](#-hello-rails-backend-2)
...
**hello-rails-backend-2** is a  app that have different greetings
...
- [Front end Link](https://github.com/addisalemseifu/hello-rails-front-end)
...
```bash
  git clone https://github.com/addisalemseifu/hello-rails-back-end-2.git
```
